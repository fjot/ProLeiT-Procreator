...
var operationTypes = ['query', 'mutation', 'subscription'].map(function (name) { return change_case_1.pascalCase(name); });
exports.handleNameDuplications = function (name, existing) {
    if (operationTypes.includes(name) || existing.find(function (model) { return model.modelType === name; })) {
